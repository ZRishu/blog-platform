...
import org.zr.blog.repositories.PostRepository;
import org.zr.blog.services.CategoryService;
...
public class PostServiceImpl implements PostService {
    ...
    public Post createPost(User user, CreatePostRequest createPostRequest) {
        ...
        newPost.setCategory(categoryService.getCategoryById(createPostRequest.getCategoryId()));
        newPost.setTags(new HashSet<>(tagService.getTagsByIds(createPostRequest.getTagIds())));
